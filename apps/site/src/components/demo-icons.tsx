...
export function IconFocalLens(props: SVGProps<SVGSVGElement>) {
  return (
...
export function IconAperture(props: SVGProps<SVGSVGElement>) {
  return (
...
export function IconShutter(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
...
export function IconIso(props: SVGProps<SVGSVGElement>) {
  return (
